...
<body>
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
        <button class="btn btn-primary mb-5" data-bs-toggle="modal" data-bs-target="#MenusModal">Nuevo</button>
     ...
     <!-- Modal -->
<div class="modal fade" id="MenusModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="Inserts/MenusInsert.php">
                    <div class="row">
                    <div class="col-6">
                        ...
                        <div class="col-6">
                        <div class="form-group">
                                    <label for="txtPrecio">Menú Precio</label>
                                    <input type="number" 
                                    class="form-control" 
                                    id="txtPrecio"
                                    name="txtPrecio"
