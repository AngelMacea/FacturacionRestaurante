...
<body>
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
        <button class="btn btn-primary mb-5" data-bs-toggle="modal" data-bs-target="#ProveedoresModal">Nuevo</button>
       ...
       <!-- Modal -->
        <div class="modal fade" id="ProveedoresModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="Inserts/ProveedoresInsert.php">
                    <div class="row">
                    <div class="col-6">
