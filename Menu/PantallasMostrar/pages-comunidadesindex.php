...
<body>
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
            <button class="btn btn-primary mb-5" data-bs-toggle="modal" data-bs-target="#ComunidadesModal">Nuevo</button>
                    ...
                    if($row = sqlsrv_fetch_array($result)){
                        ...
                        do
                        {
                                if($row['Comu_Id'] != ""){
                                    echo "<tr>";
                                    echo "<td>". $row['Comu_Id'];
                                    echo "<td>". $row['Comu_Descripcion'];
                                    echo "<td>". $row['Ciud_Descripcion'];
                                    echo "<td>". $row['Comu_TarifaEnvio'];
        ...
        <!-- Modal -->
<div class="modal fade" id="ComunidadesModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="Inserts/ComunidadesInsert.php">
                    <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                            <div class="form-group">
                                    <label for="exampleInputEmail1">Tarifa de envío</label>
                                    <input type="number" 
                                    class="form-control" 
                                    id="txtTarifa"
                                    name="txtTarifa"
                                    ...
                                    if($row = sqlsrv_fetch_array($result)){
                                        ...
                                        do
                                        {
                                                if($row['Ciud_Id'] != ""){
                                                    ...
                                                    echo "<option value=".$row['Ciud_Id'].">".$row['Ciud_Descripcion']."</option>";
                                                }
                                        }
                                        while($row = sqlsrv_fetch_array($result));
