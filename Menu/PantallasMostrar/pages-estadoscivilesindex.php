...
<body>
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
        <button class="btn btn-primary mb-5" data-bs-toggle="modal" data-bs-target="#EsCiModal">Nuevo</button>
       ...
       <!-- Modal -->
<div class="modal fade" id="EsCiModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="Inserts/EstadoCivilesInsert.php">
                    <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                                    <label for="txtEsCi">Estado Civil</label>
                                    <input type="text" 
                                    class="form-control" 
                                    id="txtEsCi"
                                    name="txtEsCi"
